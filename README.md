...
- Please read [the general instructions on how to run the labs](https://vle.must.ac.ug/mod/url/view.php?id=6584).

## Getting started

Start by downloading and unzipping **Lab2-java.zip**. It contains the following classes:
...
This assignment was conceived by Matthew Drabick and Kevin Wayne (©2014), with some changes to fit TDA417+DAT038 at Chalmers Uiversity  of Technology. We have not foreseen any changes or adaptations required for CSC 1203 at Mbarara UNiversity of Technology because managing several locals and characters will be a part of any programmer out there in the real world. So the Lab has been used without changes.
